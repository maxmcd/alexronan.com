                        ...
                        if (k) {
                            if (a.isFunction(k[e]) && "_" !== e.charAt(0)) {
                                ...
                                if (void 0 !== l) return l;
                                    ...
                                    "no such method '" + e + "' for " + b +
                                        " instance",
                                );}
                        } else {f(
                                "cannot call methods on " + b +
                    ...
                    b.isOriginLeft
                        ...
                        b.isOriginTop
                            ? (c.top = this.position.y + a.paddingTop + "px",
                                c.bottom = "")
                            : (c.bottom = this.position.y + a.paddingBottom +
                                "px",
                                c.top = ""),
                        this.css(c),
            ...
            return q.namespace = "outlayer",
                ...
                q.prototype._setContainerMeasure = function (a, b) {
                    if (void 0 !== a) {
                        ...
                        (a += b
                            ...
                            : c.paddingBottom + c.paddingTop +
                                c.borderTopWidth + c.borderBottomWidth),
                            a = Math.max(a, 0),
                            this.element.style[b ? "width" : "height"] = a +
                                "px";
                    }
                },
                ...
                q.prototype._getBoundingRect = function () {
                    ...
                    this._boundingRect = {
                        ...
                        bottom: a.bottom -
                            (b.paddingBottom + b.borderBottomWidth),
                    };
                },
        ...
        function b(a, b) {
            ...
            return d.prototype._resetLayout = function () {
                ...
                d.prototype._manageStamp = function (a) {
                    ...
                    for (
                        var i = (this.options.isOriginTop ? d.top : d.bottom) +
                                c.outerHeight,
                            j = g;
                        h >= j;
                        j++
                ...
                d.prototype._getContainerFitWidth = function () {
                    for (
                        var a = 0, b = this.cols; --b && 0 === this.colYs[b];
                    ) a++;
    ...
    function (e, t) {
        ...
        s.prototype = new t(),
            ...
            s.prototype.progress = function (e) {
                ...
                setTimeout(function () {
                    t.emit("progress", t, e),
                        t.jqDeferred && t.jqDeferred.notify &&
